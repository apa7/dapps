...
import top.apa7.dapp.constant.PrivilegeConstant;
import top.apa7.dapp.utils.crypt.Base64Util;
import top.apa7.dapp.utils.crypt.Md5Util;
import top.apa7.dapp.utils.crypt.PBEUtil;
...
public class CommUtil extends BaseLogger {
	...
	public String replaceExcelBlank(String str) {
		if (str == null) {
			return "";
		}
