...
public class EncryptUtil {
    ...
    public static void main1(String[] args) {
        ...
        // 执行MD5加密"Hello world!"
        System.out.println("Hello经过MD5:" + encryptUtil.encryptToMD5("Hello"));

        // 生成一个DES算法的密匙
        SecretKey key = encryptUtil.createSecretKey("DES");
        System.out.println(key.getAlgorithm());

        // 用密匙加密信息"Hello world!"
        String str = "aPdGs6b11db3bde1429481a9fb8597e69749ad";
        System.out.println("加密前为:" + str);
        
        String str1 = encryptUtil.encryptToDES(key, str);
