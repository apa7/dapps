 ...
 * @Copyright
 */
public class MapUtil extends BaseLogger {
    ...
    public Map<String, String> mapTransfer(Map properties) {
    ...
    public Map bean2Map(Object bean) throws IntrospectionException, IllegalAccessException, InvocationTargetException {
     ...
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Object map2Bean(Class beanClass, Map map) throws Exception {
            ...
            if (method.getName().startsWith("set")) {
                ...
                if (map.containsKey(field)) {
                    ...
                    if (value != null && !"".equals(value)) {
                        ...
                        methodType = methodType.substring(methodType.lastIndexOf(".") + 1);
                        ...
                        try {
                            ...
                            } else if (methodType.equalsIgnoreCase("string")) {
                                cache[0] = value;
                            } else if (methodType.equalsIgnoreCase("inputStream")) {
