package top.apa7.dapp.utils.redis.service.impl;
...
import top.apa7.dapp.utils.ExceptionUtil;
import top.apa7.dapp.utils.JSONUtil;
import top.apa7.dapp.utils.redis.service.IRedisService;
...
public class RedisServiceImpl implements IRedisService,RedisSerializer<Object> {
	...
	public boolean delete(Serializable key) throws Exception {
		...
		try {
			...
			flag = true;
			log.info("[RedisServiceImpl][delete][key=" + key + "][flag=" + flag + "]");
		} catch (Exception e) {
	...
	public boolean delete(Collection<Serializable> keys) throws Exception {
		...
		try {
			...
			flag = true;
			log.info("[RedisServiceImpl][delete][keys=" + keys + "][flag=" + flag + "]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public void set(Serializable key, Serializable value, long expire) throws Exception {
		try {
			...
			log.info("[RedisServiceImpl][set][key=" + key + "][expire=" + expire + "]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public void set(Serializable key, Serializable value) throws Exception {
		try {
			...
			log.info("[RedisServiceImpl][set][key=" + key + "]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public void set(Object objKey, Serializable key, Serializable value) throws Exception {
		try {
			...
			log.info("[RedisServiceImpl][set][objKey=" + objKey + "][key=" + key + "]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public Object get(Object objKey, Serializable key) throws Exception {
		...
		try {
			...
			log.info("[RedisServiceImpl][get][key=" + key + "]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public Set<Serializable> keys(String pattern) throws Exception {
		...
		try {
			...
			log.info("[RedisServiceImpl][keys][pattern=" + pattern + "]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public boolean exists(Serializable key) throws Exception {
		...
		try {
			...
			log.info("[RedisServiceImpl][exists][key=" + key + "][flag=" + flag + "]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public boolean flushDb() throws Exception {
		...
		try {
			...
			log.info("[RedisServiceImpl][flushDB][flag=" + flag + "]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public long dbSize() throws Exception {
		...
		try {
			...
			log.info("[RedisServiceImpl][dbSize][size=" + size + "]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public boolean ping() throws Exception {
		...
		try {
			...
			log.info("[RedisServiceImpl][ping][flag=" + flag + "]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public HashOperations redisHash() throws Exception {
		...
		try {
			...
			// log.info("[RedisServiceImpl][redisHash]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public ListOperations redisList() throws Exception {
		...
		try {
			...
			// log.info("[RedisServiceImpl][redisList]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public SetOperations redisSet() throws Exception {
		...
		try {
			...
			// log.info("[RedisServiceImpl][redisSet]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public ZSetOperations redisZSet() throws Exception {
		...
		try {
			...
			// log.info("[RedisServiceImpl][redisZSet]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
	...
	public ValueOperations redisValue() throws Exception {
		...
		try {
			...
			// log.info("[RedisServiceImpl][redisValue]");
		} catch (Exception e) {
			String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
			log.error(msg, e);
			throw new Exception(msg, e);
